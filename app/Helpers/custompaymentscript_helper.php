...
class CustomPaymentScript
{
	...
	public static function createPaymentScript($sellerdb,$email_id,$validation_id){
		...
		if(!empty($sellerdb)){
			...
			$filecontent .= '$("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\"'.getenv('app.ASSETSPATH').'css/rms-hosted-fields.css\" />");var hformInitialized = false;';
